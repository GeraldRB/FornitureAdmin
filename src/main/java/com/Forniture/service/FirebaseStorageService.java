...
public class FirebaseStorageService {
    ...
    public String uploadImage(MultipartFile localFile, String folder, Integer id, int index) throws IOException {
        String originalName = localFile.getOriginalFilename();
        String fileExtension = "";
        if (originalName != null && originalName.contains(".")) {
            fileExtension = originalName.substring(originalName.lastIndexOf("."));
        }
        // Se agrega el índice para que cada imagen tenga un nombre único
        String fileName = "img" + getFormattedNumber(id) + "_" + index + fileExtension;
